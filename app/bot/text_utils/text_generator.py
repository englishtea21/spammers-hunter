...
- <u>Добавить меня</u> в чаты как <u>администратора 🪪 с полномочиями банить пользователей и удалять сообщения</u>.\n
- После этого <u>введи команду в чате</u>: 
<code>/start_spam_hunting</code>. 

С этого момента антиспам начнет работу по умолчанию.
